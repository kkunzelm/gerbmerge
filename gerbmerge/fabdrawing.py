...
def writeDrillLegend(fid, Tools, OriginY, MaxXExtent):
  ...
  # dimspace = 0.5  # inches       # KHK was original line:
  ...
  # in inches.
  # glyphspace = 0.1  # inches       # KHK was original line:
  if config.Config['measurementunits'] == 'inch':  
     glyphspace = 0.1 # inches
  else:
     glyphspace = 10 # mm  = distance between glyph and glyph legend text
